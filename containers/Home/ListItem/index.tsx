...
const ListItem: React.FC<ListItemPropTypes> = ({ recipe }) => {
  ...
  return (
    <div className="flex group/item flex-row justify-between w-full h-full cursor-pointer">
      <div className="flex flex-col justify-between ">
        <div className="w-full h-full">
          ...
          <div className="overflow-auto w-full h-4/5 px-10 py-3 pr-28 border border-dashed border-yellow-900 ">
